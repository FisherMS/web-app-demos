# 设计师作品集 (Designer Portfolio) - Vue 版

这是一个基于 [Vue 3](https://vuejs.org)、[Vite 7](https://vite.dev) 和 [Tailwind CSS 4](https://tailwindcss.com) 构建的高性能、响应式设计师作品集 Web App。
...
-   **🎨 现代 UI/UX**:
    ...
    -   采用 Vue 3 Composition API (`<script setup>`) 开发。
    -   平滑的过渡动画与交互微操。
-   **🖼️ 沉浸式画廊 lightbox**:
